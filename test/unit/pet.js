...
describe('Pet', function(){
  ...
  describe('#walk', function(){
    it('should increase health, decrease energy and fullness', function(){
      var pet = new Pet('fluffy', 3, 'female', 'lizard');
      pet.health = 90;
      pet.energy = 30;
      pet.full   = 20;
  ...
  describe('#sleep', function(){
    it('should increase health and energy and decrease fullness', function(){
      var pet = new Pet('fluffy', 3, 'female', 'lizard');
      pet.health = 90;
      pet.energy = 30;
      pet.full   = 20;
  ...
  describe('#eat', function(){
    it('should increase health and fullness, decrease energy', function(){
      var pet = new Pet('fluffy', 3, 'female', 'lizard');
      pet.health = 90;
      pet.energy = 30;
      pet.full   = 20;
  ...
  describe('#attack', function(){
    ...
    it('should cause a pet with negative health to zombify', function(){
      var fluffy = new Pet('fluffy', 3, 'female', 'sloth');
      var baxter = new Pet('baxter', 5, 'male', 'monkey');
  ...
  describe('#resurrect', function(){
    ...
    it('should not resurrect the pet if they don\'t have enough wins', function(){
      var fluffy = new Pet('fluffy', 3, 'female', 'sloth');
      fluffy.isZombie = true;
      fluffy.wins = 3;
    ...
    it('should not resurrect the pet if they are not a zombie', function(){
